/*
  ...
  To check if a string is present: exists(char str[]).
  ...
  but it may have high overheads. Can use Bitset too, if needed.
  
  Checking if a string exists just takes O(M), where M is the size of the string to be searched.
*/
