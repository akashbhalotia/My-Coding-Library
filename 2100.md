...
4) https://codeforces.com/problemset/problem/1599/H
   ...
   Was able to solve it, but after a WA. It was a silly implementation error. These are increasing a lot nowadays.
   I'm not thinking while writing the code and making many silly errors. 
   
   My solution involved binary search. A better constant time solution existed, which involved some maths. Need to
   get better at maths.
